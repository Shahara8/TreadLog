...
public class WorkoutRepository : IWorkoutRepository
{
    ...
    {
        // SessionDate is the business DateTime — normalise to UTC before storing as ISO 8601
        ...
        // Audit strings: use existing value or stamp with current UTC if empty
    ...
    {
        Id              = r.GetInt32(0),
        // Parse the stored UTC ISO 8601 string back into a DateTime with Kind = Utc
        ...
        // Audit strings are passed through verbatim — no parsing in this layer
